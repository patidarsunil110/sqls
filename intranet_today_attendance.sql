...
CREATE TABLE `today_attendance` (
  ...
  KEY `emp_id` (`emp_id`),
  CONSTRAINT `today_attendance_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`emp_id`)
...
INSERT INTO `today_attendance` VALUES (1,'Monday','2018-04-22','10:08:00','07:00:00',1),(2,'Monday','2018-04-22','10:01:00','06:20:00',2),(3,'Monday','2018-04-22','09:45:00','06:25:00',3),(4,'Monday','2018-04-22','09:59:00','06:16:00',4);
