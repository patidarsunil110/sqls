...
CREATE TABLE `users_backup` (
  ...
  UNIQUE KEY `uid` (`id`),
  UNIQUE KEY `ue` (`email`),
  UNIQUE KEY `uem` (`mobile`,`email`),
  KEY `ind` (`name`,`lastname`,`password`)
...
-- Dump completed on 2019-06-17 10:18:40
